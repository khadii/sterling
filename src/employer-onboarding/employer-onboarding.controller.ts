...
export class EmployerOnboardingController {
  ...
  @ApiOperation({
    summary: 'Replace the complete Step 2 department draft',
    description:
      'Department draft IDs are generated by the API. Omit clientId for new rows; the saved response returns the server-issued ID.',
  })
  saveDepartments(
    @Req() request: RequestWithUser,
